<template>
    <div>
            ...
            <div class="modal__box" v-else>
                <div class="modal__header">
                    <h3 class="modal__title">Category Created</h3>
                </div>

                <div class="modal__body">
                    <p class="modal__text">Your Live Classes category has been created, you can now start scheduling live classes for it</p>
                </div>
...
export default {
    ...
    methods: {
        save() {
            ...
            axios.post('/api/admin/live-classes/categories', {
                name: this.name,
        ...
        uploadImage(resource_id) {
             ...
             */
            axios.post('/api/admin/live-classes/category/' + resource_id + '/upload-image', formData, {
                headers: {
