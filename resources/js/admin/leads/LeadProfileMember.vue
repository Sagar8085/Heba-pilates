<template>
    <div>
        <div class="lead-management page-content" v-if="leadID == null">
            This member does not have an associated lead profile.
            <br><br>
            <button class="button" @click="createLead">Create Lead Profile</button>
        </div>
                                ...
                                <div class="lead-management__profile__details__about__box emails">
                                    ...
                                    <div class="lead-management__profile__details__about__box__activity" v-for="email in emails">
                                        ...
                                        <div class="lead-management__profile__details__about__box__activity__container">
                                            ...
                                            <label class="lead-management__profile__details__about__box__activity__details calls">Email sent by {{email.agent.name}}</label>
                                            <label class="lead-management__profile__details__about__box__activity__extra">
                                                {{email.extra_details}}
                                            </label>
                                        </div>
                                ...
                                <div class="lead-management__profile__details__about__box" v-if="calls.length > 0">
                                    <div class="lead-management__profile__details__about__box__activity" v-for="call in calls">
                                        ...
                                        <div class="lead-management__profile__details__about__box__activity__container">
                                            ...
                                            <label class="lead-management__profile__details__about__box__activity__details calls">Call made by {{call.agent.name}}</label>
                                            <label class="lead-management__profile__details__about__box__activity__extra">
                                                {{call.outcome}}
                                    ...
                                    <div class="lead-management__profile__details__about__box__activity" v-for="appointment in appointments">
                                        ...
                                        <div class="lead-management__profile__details__about__box__activity__container">
                                            ...
                                            <label class="lead-management__profile__details__about__box__activity__details calls">
                                                Appointment Booked by {{appointment.agent.name}}
                                            </label>
                                            <label class="lead-management__profile__details__about__box__activity__extra">
        ...
        <add-note-modal v-on:cancel="loadProfile(); displayAddNoteModal = false" v-on:complete="loadProfile(); displayAddNoteModal = false;" :class="displayAddNoteModal ? 'modal modal--active' : 'modal'" :edit="true" :lead_id="this.leadID" />

        <add-note-modal v-if="note_id" v-on:cancel="loadProfile(); displayEditNotesModal = false" v-on:complete="loadProfile(); displayEditNotesModal = false;" :class="displayEditNotesModal ? 'modal modal--active' : 'modal'" :edit="false" :note_id="note_id" :lead_id="this.leadID" />

        <add-call-modal v-on:cancel="loadProfile(); displayAddCallModal = false" v-on:complete="loadProfile(); displayAddCallModal = false;" :class="displayAddCallModal ? 'modal modal--active' : 'modal'" :lead_id="this.leadID" :full_name="full_name" :image_url="image_url" :calls_made="calls_made" />

        <add-appointment-modal v-on:cancel="loadProfile(); displayAddAppointmentModal = false" v-on:complete="loadProfile(); displayAddAppointmentModal = false;" :class="displayAddAppointmentModal ? 'modal modal--active' : 'modal'" :full_name="full_name" :image_url="image_url" :calls_made="calls_made" :lead_id="this.leadID" />

        <signup-modal v-on:cancel="loadProfile(); displaySignUpModal = false" v-on:complete="loadProfile(); displaySignUpModal = false;" :class="displaySignUpModal ? 'modal modal--active' : 'modal'" :full_name="full_name" :image_url="image_url" :calls_made="calls_made" :lead_id="this.leadID" />

        <reassign-modal v-on:cancel="loadProfile(); displayReassignLeadModal = false" v-on:complete="loadProfile(); displayReassignLeadModal = false;" :class="displayReassignLeadModal ? 'modal modal--active' : 'modal'" :full_name="full_name" :lead_id="this.leadID" :image_url="image_url" />

        <log-outcome-modal v-on:cancel="displayUpdateAppointmentModal = false" v-on:complete="displayUpdateAppointmentModal = false;" :class="displayUpdateAppointmentModal ? 'modal modal--active' : 'modal'" :appointment_id="appointment_id" :lead_id="this.leadID" />
    </div>
</template>
<script>
...
export default {
    ...
    watch: {
        ...
        fitness_goal: function(value, old) {
            ...
            this.saveLead({fitness_goal: value}, 'Fitness Focus');
        },
    ...
    methods: {
        loadProfile() {
            this.loading = true;
            axios.get('/api/admin/leads/' + this.leadID)
            .then(response => {
                ...
                this.fitness_goal = response.data.lead.focuses;
        ...
        loadActivities(limit = 10) {
            axios.post('/api/admin/leads/' + this.leadID + '/activities', {
                limit
            })
            .then(response => {
        ...
        createLead() {
            axios.post('/api/admin/members/' + this.member.id + '/lead').then(response => {
                this.loadProfile();
