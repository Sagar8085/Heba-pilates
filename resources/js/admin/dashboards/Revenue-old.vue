<template>
    <div>
        ...
        <section class="tab">
            <ul>
                <li class="active"><span class="tab__link">Memberships</span></li>
                <li><router-link class="tab__link" to="/admin/dashboard/revenue/credit-packs">Credit Packs</router-link></li>
            </ul>
        </section>
        ...
        <section class="page-content">
            <div class="row row--equal">
                <div class="six four-xl columns">
                    <div class="card">
                        <p class="card__title"><span>Membership Revenue</span>Today</p>
                        <span class="card__value">£{{ periodRevenue.today }}</span>
                        <i class="card__info fas fa-info" @click="openInfo('Todays Membership Revenue', 'This is an estimation based on the amount of sales you have made. To view a complete list of transactions, in-going and out-going payments please refer to your Stripe portal.')"></i>
                    </div>
                </div>
                <div class="six four-xl columns">
                    <div class="card">
                        <p class="card__title"><span>Membership Revenue</span>This Week</p>
                        <span class="card__value card__value--green">£{{ periodRevenue.week }}</span>
                        <i class="card__info fas fa-info" @click="openInfo('This Weeks Membership Revenue', 'This is an estimation based on the amount of sales you have made. To view a complete list of transactions, in-going and out-going payments please refer to your Stripe portal.')"></i>
                    </div>
                </div>
                <div class="six four-xl columns">
                    <div class="card">
                        <p class="card__title"><span>Membership Revenue</span>This Month</p>
                        <span class="card__value">£{{ periodRevenue.month }}</span>
                        <i class="card__info fas fa-info" @click="openInfo('This Months Membership Revenue', 'This is an estimation based on the amount of sales you have made. To view a complete list of transactions, in-going and out-going payments please refer to your Stripe portal.')"></i>
                    </div>
                </div>
                <!-- <div class="six three-xl columns">
                    <div class="card">
                        <p class="card__title"><span>Membership Revenue</span>This Year</p>
                ...
                <div class="eight columns">
                    <div class="table-list">
                        <div class="table-list__header">
                            <h3>This Months Membership Performance</h3>
                        </div>
                    ...
                    <div class="graph">
                        <div class="graph__header">
                            <div class="graph__header__content">
                                <p class="graph__header__title">All Membership Sales</p>
                                <span class="graph__header__subtitle">View a list of all membership sales.</span>
                            </div>
                        </div>

                        <router-link to="/admin/memberships" class="button button--outlines" style="margin: .5rem 2rem 2rem 2rem;">View All</router-link>
                    </div>
                </div>
            </section>
        </section>
...
export default {
    ...
    methods: {
        ...
        loadStats() {
            axios.get('/api/admin/dashboard/revenue/stats').then(response => {
        ...
        loadThirtyDayTrendGraph() {
            axios.get('/api/admin/dashboard/revenue/thirty-day-trend').then(response => {
        ...
        loadTierPerformances() {
            axios.get('/api/admin/dashboard/revenue/tier-performance').then(response => {
