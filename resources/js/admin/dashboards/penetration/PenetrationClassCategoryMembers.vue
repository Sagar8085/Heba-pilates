        ...
        <section class="page-header page-header--no-bottom">
            <div class="wrapper">
                <div class="page-header__col">
                    ...
                    <h2 class="page-header__sub">Category Member Penetration</h2>
                </div>
            </div>
        </section>
...
export default {
    ...
    methods: {
        loadMembers(download = false, page = 1) {
            axios.post('/api/admin/dashboard/penetration/members?type=class-category&id=' + this.$route.params.id + '&page=' + page + '&download=' + download, {
                ages: this.ages,
