            ...
            <div class="wrapper">
                <div class="page-header__col">
                    <h1 class="page-header__title">
                        ...
                        Virtual Coaching | {{ this.$route.params.duration }} Min Sessions
                    </h1>

                    <h2 class="page-header__sub">Virtual Coaching Member Penetration List</h2>
                </div>
            </div>
        </section>
...
export default {
    ...
    methods: {
         ...
         */
        loadPodcast() {
            axios.get('/api/admin/podcasts/library/' + this.$route.params.episode_id).then(response => {
        ...
        loadMembers(download = false, page = 1) {
            axios.post('/api/admin/dashboard/penetration/classes/1/members?page=' + page + '&download=' + download, {
                ages: this.ages,
