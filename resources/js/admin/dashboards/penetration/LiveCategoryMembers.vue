        ...
        <section class="page-header page-header--no-bottom">
            <div class="wrapper">
                <div class="page-header__col">
                    ...
                    <h2 class="page-header__sub">Member Penetration List</h2>
                </div>
            </div>
        </section>
...
export default {
    ...
    methods: {
        ...
        loadMembers(download = false, page = 1) {
            axios.post('/api/admin/dashboard/penetration/members?type=live-category&id=' + this.$route.params.category_id + '&page=' + page + '&download=' + download, {
                ages: this.ages,
