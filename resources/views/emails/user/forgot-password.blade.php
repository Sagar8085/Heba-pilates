    ...
    <div role="article" aria-label="An email from The Fitness Concierge" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
        ...
        <header>
            ...
            <h1 style="color: #000000; font-size: 32px; font-weight: 800; line-height: 32px; margin: 48px 0; text-align: center;">
                Reset Your <br>Forgotten Password
            </h1>
        </header>
        ...
        <main>
            ...
            <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                ...
                <!-- Body copy -->
                <p>
                    Hi {{ $props['user']->first_name }}! We're sorry to hear that you are having trouble getting into your Heba Pilates account, but not to worry! Use the link below to reset your password, after which you can log in as usual.
                </p>
                ...
                <a href="{{ env('APP_URL') }}/reset/{{ $props['token']->token }}" style="color: #2E91FC; text-decoration: underline;">Reset your password now</a>

                <p>
                    If you think this email was sent in error, you can ignore this request as only access to this email and your inbox will allow your password reset to occur.
                </p>
                <!--[if (gte mso 9)|(IE)]>
                </td></tr></table>
                <![endif]-->
