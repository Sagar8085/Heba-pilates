...
    <title>Your Heba Pilates membership </title>
...
  <body style="margin: 0 !important; padding: 0 !important;">
    ...
    <div role="article" aria-label="An email from Your Brand Name" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
        ...
        <main>
            ...
            <p>Thank you {{ $props['user']->first_name }} for purchasing a membership with Heba Pilates.</p>
            <p>Your membership is active immediately so go ahead and make your booking for your nearest studio.</p>
            <p>As a Heba member remember you can book up to a full month in advance for your sessions. </p>
            <p style="text-align:center; padding:40px 0;"><a href="{{ env('APP_URL') }}/studio" class="button">Book a Session</a></p>
            <p>All monthly credits are valid for two months each time they land in your membership account so you always have your full months booking allowance available for you.</p>

            <p>If you would like to purchase additional credits to supplement and build upon your membership allowance, as a valued Heba member you receive our preferential rate of just £12 per session. To add any additional sessions at any time, please do so via your Heba App or by speaking with one of our in studio Guides.</p>
            <p>Please be aware direct debit payments may take up to 5 working days to process and authorise through your bank.</p>
            <p>For any billing queries please email <a href="mailto:hello@hebapilates.com">hello@hebapilates.com</a></p>
            <p>Thank you again {{ $props['user']->first_name }} and welcome to your Heba membership.</p>
            <br>
            <p>Healthy regards,</p>
            <h4>Heba Pilates</h4>
