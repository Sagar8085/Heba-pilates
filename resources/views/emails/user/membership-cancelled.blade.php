...
    <title>Confirmation of Heba Pilates subscription cancellation</title>
...
  <body style="margin: 0 !important; padding: 0 !important;">
    ...
    <div role="article" aria-label="An email from The Fitness Concierge" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
        ...
        <header>
            ...
            <a href="{{ env('APP_URL') }}">
                <center><img src="https://s3.eu-west-2.amazonaws.com/prod.hebepilates/emails/hebalogo-stripeline-dark.png" alt="" height="80" width="300"></center>
            </a>
        ...
        <main>
            ...
            <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                ...
                <!-- Body copy -->
                <p>Dear {{ $props['user']->first_name }}</p>
                <p>Thank you for being part of our Heba community and we are very sorry to see you have requested to stop your subscription plan.</p>
                <p>As per your request, your subscription has been cancelled on {{ date('g:ia l dS F Y') }}</p>
                <p>You have {{ $props['subscription']->studio_credits_human }} credits to use until {{ $props['subscription']->expires_human }}.</p>
                <p>We would love to see you in our studio again and so please remember you are very welcome to visit and to join again any time should your circumstances change.</p>
                <p>We'd like to learn the reason behind your cancellation and any feedback you may like to share so we can best serve our Guests (and hopefully you) in the future.</p>
                <p><a href="https://docs.google.com/forms/d/e/1FAIpQLSd7nWkOb7iP5fGGpWhjZLpDpalie8J-tyndDiTDzmUaozAFJw/viewform" class="button">Share feedback</a></p>
                <p>Many thanks again {{ $props['user']->first_name }}, we hope to see you again soon.</p>
                <p>Kindest regards,</p>
                <p>Team Heba</p>
        ...
        <footer>
            ...
            <p style="font-size: 16px; font-weight: 400; line-height: 24px; margin-top: 48px;">
                You received this email because it is an important notification regarding your Heba Pilates account.
            </p>
