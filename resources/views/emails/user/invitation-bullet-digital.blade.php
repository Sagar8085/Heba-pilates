...
  <body style="margin: 0 !important; padding: 0 !important;">
    ...
    <div style="display: none; max-height: 0; overflow: hidden;">
        Your {{ env('APP_NAME') }} account is nearly ready, finish your account setup to begin your journey.
    </div>
    ...
    <div role="article" aria-label="An email from {{ env('APP_NAME') }}" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
        ...
        <header>
            ...
            <a href="{{ env('APP_URL') }}">
                <center><img src="https://s3.eu-west-2.amazonaws.com/prod.hebepilates/emails/hebalogo-stripeline-dark.png" alt="Heba Pilates" width="320" height="85"></center>
            </a>
            ...
            <h1 style="color: #000000; font-size: 32px; font-weight: 800; line-height: 32px; margin: 48px 0; text-align: center;">
                Thanks for joining<br>{{ env('APP_NAME') }}!
            </h1>
        </header>
        ...
        <main>
            ...
            <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                ...
                <!-- Body copy -->
                <p>
                    Hi {{ $props['user']->first_name }}! Thanks for joining {{ env('APP_NAME') }} we're very excited to have you on-board. There's just 1 step left and that's to set your password. Please follow the link below gain access to your account.
                </p>
                ...
                <a href="{{ env('APP_URL') }}/admin/setup/{{ $props['token']->token }}" style="color: #2E91FC; text-decoration: underline;">Finish Setup</a>

                <p>
                    If you think this email was sent in error, please contact {{ env('APP_NAME') }} as an account using this email address has been setup.
                </p>
                <!--[if (gte mso 9)|(IE)]>
                </td></tr></table>
                <![endif]-->
        ...
        <footer>
            ...
            <p style="font-size: 16px; font-weight: 400; line-height: 24px; margin-top: 48px;">
                You received this email because it is an important notification regarding your {{ env('APP_NAME') }} account.
            </p>
