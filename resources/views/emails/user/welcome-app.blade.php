...
    <style type="text/css">
        ...
        a.button{ background: #B200FD; color: white !important; border-radius:40px; padding:20px 40px; margin:40px auto; text-decoration: none; }
...
  <body style="margin: 0 !important; padding: 0 !important;">
    ...
    <div role="article" aria-label="An email from Your Brand Name" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
        ...
        <header>
            ...
            <a href="{{ env('APP_URL') }}">
                <center><img src="https://s3.eu-west-2.amazonaws.com/prod.hebepilates/emails/hebalogo-stripeline-dark.png" alt="" height="80" width="80"></center>
            </a>
            ...
            <h1 style="color: #000000; font-size: 32px; font-weight: 800; line-height: 32px; margin: 48px 0; text-align: center;">
                Hi {{ $props['user']->first_name }}! Welcome to Heba Pilates
            </h1>
        </header>
        ...
        <main>
            <!-- Since this is a purely decorative image, we can leave the alternative text blank. -->
            <!-- Linking images also helps with Gmail displaying download links next to them. -->
            <a><img alt="" src="https://images.unsplash.com/flagged/photo-1573556291531-a5d957d7e4e7?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80" width="600" border="0" style="border-radius: 4px; display: block; max-width: 100%; min-width: 100px; width: 100%;"></a>
            <!-- A level 2 heading is used to keep the document order correct. -->
            
            <p style="text-align: center;">
               Thank you {{ $props['user']->first_name }}! for downloading the Heba Pilates App. Upon sign in, you will be able to create studio bookings, manage your membership profile and access to our studios and content.</p>

                <p>If you have not already taken advantage of our 2 week unlimited offer, make sure you click the button below to purchase this one time only offer. </p>
                 <p style="text-align:center; padding:20px 0;"><a href="{{ env('APP_URL') }}/membership" class="button">One Time Offer</a></p>

                <p>Sessions are valid across all of our studio locations where you will be met by our team of Guides to ensure you get the most out of every visit.</p>

                <p>We can’t wait to welcome you to our studios.</p>
                <br>
                <p>Kindest regards,</p>
        ...
        <footer>
            ...
            <p style="font-size: 16px; font-weight: 400; line-height: 24px; margin-top: 48px;">
                You received this email because you just signed up to Heba Pilates using this email address. Don't worry, if you don't want to receive marketing communications from us <a href="{{ env('APP_URL') }}/myaccount/marketing" style="color: #B200FD; text-decoration: underline;">you can unsubscribe here</a>.
            </p>
