...
    <style type="text/css">
        ...
        a.button{ background: #17B5C8; color: white !important; border-radius:40px; padding:10px 20px; margin:50px auto; text-decoration: none; }
...
  <body style="margin: 0 !important; padding: 0 !important;">
    ...
    <div style="display: none; max-height: 0; overflow: hidden;">
        Your booking for {{ $props['booking']->time_human . ' ' . $props['booking']->date_human }} is cancelled..
    </div>
    ...
    <div role="article" aria-label="" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
        ...
        <main>
            ...
            <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                ...
                <p>Your session on {{ $props['booking']->time_human . ' ' . $props['booking']->date_human }} at {{ $props['booking']->reformer->gym->name }} has been cancelled. </p>
                <p>Click below to reschedule your booking.</p>
                 <p style="text-align:center; padding:40px 0;"><a href="{{ env('APP_URL') }}/studio" class="button">Reschedule Booking</a></p>
        ...
        <footer>
            ...
            <p style="font-size: 16px; font-weight: 400; line-height: 24px; margin-top: 48px;">
                You received this email because it is an important notification regarding your Heba Pilates account. If you did not cancel this booking or believe this is an error please contact us at <a href="mailto:hello@hebapilates.com">hello@hebapilates.com</a>
            </p>
