...
  <body style="margin: 0 !important; padding: 0 !important;">
    ...
    <div style="display: none; max-height: 0; overflow: hidden;">
        Your booking for {{ $props['booking']->time_human . ' ' . $props['booking']->date_human }} is accepted.
    </div>
        ...
        <main>
            ...
            <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                ...
                <p>Thank you for booking your Heba Pilates session.</p>
                 ...
                 <p>Your session is confirmed for {{ $props['booking']->time_human . ' ' . $props['booking']->date_human }} at {{ $props['booking']->reformer->gym->name }}. </p>
                ...
                <p style="text-align:center; padding:20px 0;">
                    <a href="{{ $props['appleCal'] }}" class="button">Add to Calendar</a>
                </p>
