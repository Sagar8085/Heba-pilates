...
    <title>Heba Pilates Intro Pack Offer - Don’t miss out</title>
    ...
    <div role="article" aria-label="An email from The Fitness Concierge" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
        ...
        <header>
            ...
            <h1 style="color: #000000; font-size: 32px; font-weight: 800; line-height: 32px; margin: 48px 0; text-align: center;">
                Heba Pilates Intro Pack Offer - Don’t miss out
            </h1>
        </header>
        ...
        <main>
            ...
            <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                ...
                <!-- Body copy -->
                <p>
                    Hi {{ $props['user']->first_name }}, thanks again for downloading our app and creating your account.   </p>

                <p>Don’t forget to take advantage of our three session introductory offer and book in at your nearest Heba Studio. </p>

                <p>Our Intro Pack is the perfect way to get started, become familiar with our Nuforma machines and set off on the right foot.</p>

                <a class="button" href="{{ env('APP_URL') }}/membership"
                style="background-color:#2E91FC;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;font-weight:bold;line-height:60px;text-align:center;text-decoration:none;width:300px;-webkit-text-size-adjust:none;">View Memberships</a>
