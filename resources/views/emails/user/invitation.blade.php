...
  <body style="margin: 0 !important; padding: 0 !important;">
    ...
    <div style="display: none; max-height: 0; overflow: hidden;">
        You've been invited to join {{ env('APP_NAME') }}. Follow the instructions to finish setting up your account.
    </div>
    ...
    <div role="article" aria-label="An email from {{ env('APP_NAME') }}" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
        ...
        <header>
            ...
            <a href="{{ env('APP_URL') }}">
                <center><img src="https://s3.eu-west-2.amazonaws.com/prod.hebepilates/emails/hebalogo-stripeline-dark.png" alt="" height="320" width="85"></center>
            </a>
        ...
        <main>
            ...
            <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                ...
                <!-- Body copy -->
                <p>
                    Hi {{ $props['user']->first_name }}! You have been invited to join {{ env('APP_NAME') }}, please tap on the button below to finish setting up your account.
                </p>
                ...
                <a href="{{ env('APP_URL') }}/admin/setup/{{ $props['token']->token }}" style="color: #2E91FC; text-decoration: underline;">Setup Your Account Now</a>

                <p>
                    If you think this email was sent in error, please contact {{ env('APP_NAME') }} as an account using this email address has been invited to join.
                </p>
                <!--[if (gte mso 9)|(IE)]>
                </td></tr></table>
                <![endif]-->
