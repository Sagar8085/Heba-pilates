    ...
    <div role="article" aria-label="An email from Your Brand Name" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
        ...
        <main>
            ...
            <h2 style="color: #000000; font-size: 28px; font-weight: 600; line-height: 32px; margin: 48px 0 24px 0; text-align: center;">
                Virtual Fitness Classes, Anytime - Anywhere
            </h2>
            <p style="text-align: center;">
                Keep your body healthy and in shape, with hundreds of live and on-demand fitness classes that you can watch on any device, at any time. Recorded by our specialist trainers they're sure to keep you pushing your limits, with classes for all fitness enthusiasts.
            </p>
            <!-- This paragraph uses column-count for multiple columns. A more robust solution would require more tables... -->
            <p style="column-count: 2; line-height: 2; text-align: center;">
                ✅ Yoga<br>
                ✅ Muscle Training<br>
                ✅ Body Building<br>
                ✅ Cardio<br>
            ...
            <center>
                ...
                style="background-color:#2E91FC;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;font-weight:bold;line-height:60px;text-align:center;text-decoration:none;width:300px;-webkit-text-size-adjust:none;">Browse Heba</a>
                <!--[if mso]>
                </center>
                </v:roundrect>
                <![endif]--></div>
