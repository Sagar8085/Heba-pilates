...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function roundSum($precision = 2)
        {
                        return \Illuminate\Support\Collection::roundSum($precision);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function roundAll($precision = 2)
        {
                        return \Illuminate\Support\Collection::roundAll($precision);
        }
