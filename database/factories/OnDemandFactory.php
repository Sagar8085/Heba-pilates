...
class OnDemandFactory extends Factory
{
    /**
     ...
     * @var string
     */
    protected $model = OnDemand::class;
    ...
    public function definition()
    {
        ...
        return [
            ...
            'video_path' => 'https://volution-transcoded-videos.s3-eu-west-1.amazonaws.com/on-demand/raw-videos/3vSJ2cLRtkGl6xSwcvAKJVn0VxsB1PbTu2IclTIk.mp4',
